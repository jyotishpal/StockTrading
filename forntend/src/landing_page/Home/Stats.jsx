    ...
    return ( 
        <div className="container mt-5 p-5">
            ...
            <div className="col-6 mt-1 px-5">
             <img src="media/images/ecosystem.png" alt="Stat_Image" style={{width:"120%"}} />
             <div className="text-center  pr-5">
                <a href="" style={{textDecoration:"none"}} className="mx-5" >Explore our products<i class="fa-solid fa-arrow-right"></i></a>
                <a href="" style={{textDecoration:"none"}} className="mx-4" >Try Kite demo<i class="fa-solid fa-arrow-right"></i> </a>
             </div>
